...
export function buildInitialPromptPayload(
  ...
  const promptText = [
    ...
    'Your role is OBSERVATION AND ANALYSIS ONLY. You must:',
    '- NEVER modify, write, or delete any files',
    '- NEVER execute commands or scripts which modify the codebase or dependencies',
    '- NEVER make network requests beyond reading documentation',
    '- ONLY read files to understand the codebase',
    ...
    '- Suggest practical next actions for the developer',
